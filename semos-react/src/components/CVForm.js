        ...
        return (
            ...
            <div>
                ...
                <form onSubmit = {this.handleSubmit} noValidate>
                    ...
                    <input type="text" name="address" placeholder="Address of Residence" />
                    ...
                    <input type="text" name="level-of-education" placeholder="Educational Level" />

                    <p>Type of Degree</p>
                    <input type="text" name="type-of-degree" placeholder="Type of Degree" />

                    <p>Start At</p>
                    <input type="text" name="start-of-education" placeholder="Year you Started Your Education" />

                    <p>Finish At</p>
                    <input type="text" name="end-of-education" placeholder="Year You Finished Your Education" />

                    <p class="section">Experience</p>

                    <p>Position</p>
                    <input type="text" name="job-description" placeholder="Job Title" />

                    <p>Job Description</p>
                    <textarea id="job-description" name="job-description" rows="5" cols="20">
                    </textarea>
                    ...
                    <p>Employer</p>
                    <input type="text" name="employer" placeholder="Name Of Employer" />

                    <p>Start At</p>
                    <input type="text" name="start-work" placeholder="Year you Started Working There" />

                    <p>Finish At</p>
                    <input type="text" name="end-work" placeholder="Year you Ended Working There" />

                    <p class="section">Skills</p>
                    <p>Languages</p>
                    <input type="text" name="languages" placeholder="Languages You Speak" />
                    <p>Communicational Skills</p>
                    <input type="text" name="communicational-skills" placeholder="Your Communicational Skills" />
                    <p>Organizational Skills</p>
                    <input type="text" name="organizational-skills" placeholder="Your Organizational Skills" />
                    <p>Digital Skills</p>
                    <input type="text" name="digital-skill" placeholder="Your Digital Skills" /><br/>

                        <button id="create-cv">Press To Create CV</button>
                        </form>
